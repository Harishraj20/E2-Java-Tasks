  ...
  <body>
    ...
    <div class="pagination">
      ...
      <c:if test="${currentPage > 1}">
        <a href="/finaltask/users/viewInfo?userId=${userId}&page=${currentPage - 1}&pageSize=10">Previous</a>
      </c:if>
      ...
      <c:forEach begin="1" end="${totalPages}" var="i">
        <c:choose>
          ...
          <c:otherwise>
            <a href="/finaltask/users/viewInfo?userId=${userId}&page=${i}&pageSize=10">${i}</a>
          </c:otherwise>
        </c:choose>
      </c:forEach>
      ...
      <c:if test="${currentPage < totalPages}">
        <a href="/finaltask/users/viewInfo?userId=${userId}&employeeId=${empId}&page=${currentPage + 1}&pageSize=10">Next</a>
      </c:if>
    </div>
